...
| [`LEDGER-0017`](LEDGER-0017-uptime-under-nephew-tower/) | Move Uptime Kuma under Nephew Tower — `nephew.yousirjuan.ai/uptime/` (one Tower, one URL) | `in-progress` | 2026-05-21 | _pending_ | `sudo bash ledger/LEDGER-0017-uptime-under-nephew-tower/playbooks/move-uptime-under-nephew.sh` |
