...
**Latest update:** 2026-06-25 — [`LEDGER-0036`](ledger/LEDGER-0036-mac-fleet-bonjour-file-sharing/) Mac fleet Bonjour file sharing on fivemac + nephew-spark: Samba/SFTP mounts by hostname, admin-only SMB, DGX avahi/docker mDNS fix, onemac/twomac bootstrap path. See [journal.md](ledger/LEDGER-0036-mac-fleet-bonjour-file-sharing/journal.md), PAIN-0011/0012.
**Previous update:** 2026-05-20 — v0.2.0 bump + initialized docs/CHANGELOG/Issue-Log/Feature Ledger. 0.2.0 ships: the [`/ledger/`](ledger/) self-codifying system, [`LEDGER-0001`](ledger/LEDGER-0001-imac-mcp-setup/) (iMac MCP stack), [`LEDGER-0002`](ledger/LEDGER-0002-workflow-debugger-agent/) (workflow-debugger Claude Code agent), the CI contract-allowlist fix, and the `release-intel-mac.yml` YAML parse fix.
